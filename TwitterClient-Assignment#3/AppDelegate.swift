...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        if (User.currentUser != nil){
            ...
            let twiterViewController = UIStoryboard.TwitterController()! as twitterViewController
            
            let menuViewController = UIStoryboard.MenuController()! as MenuViewController
...
extension UIStoryboard {
    ...
    class func TwitterController() -> twitterViewController? {
        return mainStoryboard().instantiateViewControllerWithIdentifier("twitterViewController") as? twitterViewController
    }
